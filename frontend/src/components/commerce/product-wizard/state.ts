...
export function mergeIntelligence(
  ...
  return {
    ...
    basic: {
      ...
      warehouseId: String(basic.warehouseId ?? state.basic.warehouseId ?? ''),
      warehouseName: String(basic.warehouseName ?? state.basic.warehouseName ?? ''),
      rackId: String(basic.rackId ?? state.basic.rackId ?? ''),
      rackRow: String(basic.rackRow ?? state.basic.rackRow ?? ''),
      locationId: String(basic.locationId ?? state.basic.locationId ?? ''),
