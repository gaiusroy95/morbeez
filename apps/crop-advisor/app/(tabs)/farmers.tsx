...
import { cropAdvisorClient, t, tokens, type CropAdvisorOperationalLeadRow } from '@morbeez/shared';
...
export default function FarmersScreen() {
  ...
  const [farmers, setFarmers] = useState<CropAdvisorOperationalLeadRow[]>([]);
  ...
  const load = useCallback(async () => {
    setError('');
    try {
      const rows = await cropAdvisorClient.listOperationalLeads({
        scope: 'mine',
