...
import { cropAdvisorClient, tokens, type CropAdvisorWorkspaceSummary } from '@morbeez/shared';
...
export default function LeadWorkspaceScreen() {
  ...
  const [summary, setSummary] = useState<CropAdvisorWorkspaceSummary | null>(null);
  ...
  const load = useCallback(async () => {
    ...
    setError('');
    try {
      setSummary(await cropAdvisorClient.getLeadWorkspaceSummary(id));
    } catch (e) {
