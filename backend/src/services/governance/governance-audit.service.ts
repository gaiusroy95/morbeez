...
export const governanceAuditService = {
  ...
  async append(input: AuditAppendInput): Promise<{ sequence: number; eventHash: string }> {
  ...
  async verifyChain(limit = 500): Promise<{ ok: boolean; checked: number; brokenAt?: number }> {
