...
export const seoKeywordsService = {
  ...
  async upsert(input: {
    ...
    else q = q.is('target_type', null);
    if (input.targetId) q = q.eq('target_id', input.targetId);
