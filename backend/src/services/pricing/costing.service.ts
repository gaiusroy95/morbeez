...
export function computeLandedUnitCost(input: LandedCostInput): number {
...
export const costingService = {
  ...
  async updateWeightedAverageCost(inventoryItemId: string, incomingQty: number, landedUnitCost: number) {
