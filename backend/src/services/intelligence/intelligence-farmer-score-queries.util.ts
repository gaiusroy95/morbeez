...
export async function fetchRetentionByFarmerIds(
  farmerIds: string[]
): Promise<Map<string, RetentionSnapshot>> {
  const map = new Map<string, RetentionSnapshot>();
...
export async function fetchOpportunityScoresByFarmerIds(
  farmerIds: string[]
