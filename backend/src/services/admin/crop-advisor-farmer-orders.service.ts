...
function extractCommerceLineItems(raw: Record<string, unknown> | null): CropAdvisorOrderLine[] {
...
function mapManualRow(r: Record<string, unknown>): CropAdvisorOrderRow {
  const items = (r.line_items as CropAdvisorOrderLine[]) ?? [];
...
function mapCommerceRow(r: Record<string, unknown>): CropAdvisorOrderRow {
...
export const cropAdvisorFarmerOrdersService = {
