...
import {
  telecallerAdminService,
  type LeadStage,
  type TelecallerListQuery,
} from './telecaller-admin.service.js';
import {
...
export type OperationalLeadRow = Awaited<
  ReturnType<typeof telecallerAdminService.listLeads>
>['leads'][number] & {
  ...
  async bulkUpdateLeads(
    ...
    if (action === 'change_stage' && payload.stage) {
      for (const id of leadIds) {
        await telecallerAdminService.updateLead(
          id,
