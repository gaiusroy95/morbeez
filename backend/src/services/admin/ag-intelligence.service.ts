...
export const agIntelligenceService = {
  // ─── Weather rules ───────────────────────────────────────────
  async listWeatherRules(params?: { status?: string; cropType?: string }) {
    let q = supabase
    ...
    if (params?.cropType) q = q.eq('crop_type', params.cropType);
  ...
  // ─── Cultivation tasks ───────────────────────────────────────
  async listCultivationTasks(cropType?: string) {
    let q = supabase
  ...
  async listRecommendationTemplates(params?: { status?: string; cropType?: string }) {
    let q = supabase
  ...
  // ─── Resistance rotation ─────────────────────────────────────
  async listResistanceRotation(cropType?: string) {
    let q = supabase
  ...
  async deleteRow(table: string, id: string) {
    ...
    if (!allowed.includes(table)) throw new NotFoundError('Invalid table');
