...
export const leadCaptureService = {
  async captureAndIdentify(msg: InboundMessage, languageHint: AdvisoryLanguage) {
    ...
    const storedLang = (farmer.preferred_language ?? languageHint ?? 'en') as AdvisoryLanguage;
