...
export type PlaybookResult =
  ...
  | { action: 'reply'; message: string; escalate?: boolean };
...
const COPY: Record<AgricultureInputCategory, Record<AdvisoryLanguage, PlaybookCopy>> = {
  disease_stress: {
  ...
  cultivation: {
    en: {
      ...
      expertEscalation:
        'We cannot diagnose crop disease from a product bag photo.\n\nSend a clear leaf/plant photo, or type *call* for help.',
    },
    ml: {
      ...
      expertEscalation:
        'ഉൽപ്പന്നം ബാഗ് ഫോട്ടോയിൽ നിന്ന് രോഗനിർണയം സാധ്യമല്ല.\n\nവ്യക്തമായ ഇല ഫോട്ടോ അയയ്ക്കുക, അല്ലെങ്കിൽ *call*.',
    },
    ta: {
