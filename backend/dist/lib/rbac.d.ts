...
export type ConsoleModule = 'dashboard' | 'crop_advisor_crm' | 'operations' | 'intelligence' | 'agronomist' | 'commerce' | 'warehouse' | 'seo' | 'automation' | 'analytics' | 'settings' | 'approve_recommendations' | 'partner_program' | 'channel_pool' | 'ai_calling';
