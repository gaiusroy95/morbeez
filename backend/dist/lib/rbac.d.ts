...
export type ConsoleModule = 'dashboard' | 'telecaller_crm' | 'operations' | 'intelligence' | 'agronomist' | 'commerce' | 'warehouse' | 'seo' | 'automation' | 'analytics' | 'settings' | 'approve_recommendations' | 'partner_program';
