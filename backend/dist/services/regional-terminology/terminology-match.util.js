 ...
 */
export function lexiconSpecificityScore(row, scope) {
    ...
    if (rowCrop && wantCrop && rowCrop !== wantCrop)
        return -1;
...
export function pickBestScopedRow(rows, scope) {
    let best = null;
    let bestScore = -1;
...
export function normalizeLexiconToken(token) {
    return token.trim().toLowerCase();
}
//# sourceMappingURL=terminology-match.util.js.map