...
export const regionalTerminologyProcessor = {
    ...
    async processInbound(params) {
        ...
        const isShortUnknownOnly = wordCount <= 4 && !isExplicitAgronomyQuestion(params.text) && detection.knownTerms.length === 0;
...
//# sourceMappingURL=regional-terminology.processor.js.map