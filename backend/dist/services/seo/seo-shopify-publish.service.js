...
export const seoShopifyPublishService = {
    async publishToShopify(pageId) {
        ...
        if (shopifyPageId) {
            const res = await shopifyAdmin(`/pages/${shopifyPageId}.json`, {
                method: 'PUT',
            ...
            const res = await shopifyAdmin('/pages.json', {
                method: 'POST',
    ...
    async unpublishFromShopify(pageId) {
        const page = await seoPagesService.get(pageId);
...
//# sourceMappingURL=seo-shopify-publish.service.js.map