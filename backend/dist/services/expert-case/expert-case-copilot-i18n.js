export function normalizeCopilotLocale(value) {
    const v = String(value ?? 'en').trim().toLowerCase();
    if (v === 'hi' || v === 'ml' || v === 'ta' || v === 'kn')
        return v;
    return 'en';
}
const CATALOG = {
    en: {
        ...
        validationsAttached: 'Compatibility, weather, FRAC, phytotoxicity, and safety checks attached to the structured preview.',
        clarifyDiagnosis: 'Which diagnosis and treatment should I apply to the draft?',
        askLabelDose: 'Manufacturer label dose detected. Use the registered label dosage for this formulation?',
        askDilution: 'What spray tank / dilution volume should I record (liters of water)?',
    ...
    hi: {
        ...
        validationsAttached: 'मिक्स, मौसम, FRAC, फाइटोtoxicity और सुरक्षा जाँच संरचित पूर्वावलोकन में जुड़ी हैं।',
    ...
    ml: {
        ...
        validationsAttached: 'മിക്സ്, കാലാവസ്ഥ, FRAC, ഫൈറ്റോടോക്സിസിറ്റി, സുരക്ഷാ പരിശോധനകൾ പ്രിവ്യൂവിൽ ചേർത്തു.',
    ...
    ta: {
        ...
        validationsAttached: 'கலவை, வானிலை, FRAC, பைட்டோடாக்சிசிட்டி, பாதுகாப்பு சரிபார்ப்புகள் முன்னோட்டத்தில் இணைக்கப்பட்டன.',
    ...
    kn: {
        ...
        validationsAttached: 'ಮಿಶ್ರಣ, ಹವಾಮಾನ, FRAC, ಫೈಟೊಟಾಕ್ಸಿಸಿಟಿ ಮತ್ತು ಸುರಕ್ಷತಾ ಪರಿಶೀಲನೆಗಳು ಪೂರ್ವವೀಕ್ಷಣೆಯಲ್ಲಿ ಸೇರಿವೆ.',
...
export function copilotMsg(locale, key, vars) {
...
export function defaultFarmerQuestions(locale) {
    return [
...
export function toAdvisoryLanguage(value) {
    const v = normalizeCopilotLocale(value);
    return v;
}
//# sourceMappingURL=expert-case-copilot-i18n.js.map