...
import { parseDilutionVolumeL, parseTreatmentActivitiesFromMessage, supplementTreatmentDraft, } from '../expert-case-treatment-extraction.service.js';
describe('Expert treatment extraction', () => {
    ...
    it('splits composite spray and drench recommendations into activities', () => {
        const message = 'Spray 1kg 13:00:45 with 300 ml tebuconazole + Trifloxystrobin and drench 4 kg SOP with micronutrient mixture every 10 days';
    ...
    it('asks for dilution when foliar spray has no water volume', () => {
        const draft = supplementTreatmentDraft(emptyExpertCaseDraft(), 'Spray Azoxystrobin 300 ml foliar');
    ...
    it('records dilution volume when provided in the same message', () => {
        const draft = supplementTreatmentDraft(emptyExpertCaseDraft(), 'Spray 300 ml fungicide in 200 liter water and drench 4 kg SOP');
...
//# sourceMappingURL=expert-case-treatment-extraction.test.js.map