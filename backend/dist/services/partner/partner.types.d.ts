...
export type PartnerStatus = 'applied' | 'verified' | 'training' | 'certified' | 'active' | 'suspended' | 'inactive';
export type PartnerTier = 'associate' | 'certified' | 'senior' | 'master';
export type PartnerAttributionType = 'enrollment' | 'visit' | 'meeting' | 'soil_collection' | 'conversion_assist' | 'reactivation';
