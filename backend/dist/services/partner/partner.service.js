...
function referralUrl(slug, partnerCode) {
...
export const partnerService = {
    mapRow(row) {
        ...
        return {
            ...
            cropsExpertise: row.crops_expertise ?? [],
            referralSlug: slug,
    ...
    async updateStatus(partnerId, toStatus, reason, changedBy) {
    ...
    async updateTier(partnerId, tier, changedBy) {
        const { data, error } = await supabase
            .from('partners')
    ...
    async incrementActiveFarmers(partnerId, delta = 1) {
