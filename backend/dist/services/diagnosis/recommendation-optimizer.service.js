...
export const recommendationOptimizerService = {
    async buildOptions(input) {
        ...
        return defaults.map((p, i) => {
            ...
            if (segment === 'premium' && recovery >= 88)
                roiNote = 'Best recovery — premium segment fit';
            if (segment === 'low_budget' && p.costInr <= 2000)
                roiNote = 'Lowest cost — budget segment fit';
...
//# sourceMappingURL=recommendation-optimizer.service.js.map