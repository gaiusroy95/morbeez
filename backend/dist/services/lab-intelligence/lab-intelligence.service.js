...
export const labIntelligenceService = {
    async loadForFarmer(farmerId, blockId) {
        const reports = [];
        let soilQ = supabase
        ...
        let waterQ = supabase
            ...
            .limit(1);
        if (blockId)
            waterQ = waterQ.eq('block_id', blockId);
        ...
        let leafQ = supabase
            ...
            .limit(1);
        if (blockId)
            leafQ = leafQ.eq('block_id', blockId);
        ...
        let pathogenQ = supabase
            ...
            .limit(1);
        if (blockId)
            pathogenQ = pathogenQ.eq('block_id', blockId);
...
//# sourceMappingURL=lab-intelligence.service.js.map