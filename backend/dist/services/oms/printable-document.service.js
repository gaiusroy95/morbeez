...
import { computeInclusiveGstBreakup, finalizeInclusiveInvoiceTotals, halfGstRate, isSameIndianState, normalizeIndianState, } from '../../lib/gst.js';
...
import { computeFulfillmentGates, isPrintableDocAvailable, resolvePickComplete, } from '../../lib/fulfillment-gates.js';
...
export const printableDocumentService = {
    ...
    async buildTaxInvoice(invoiceId) {
        ...
        const needsTaxRepair = data.document_type === 'tax_invoice' &&
        ...
        const companyState = normalizeIndianState(String(companyLive.state || companySnap.state || data.company_state || ''));
        const customerState = normalizeIndianState(String(data.customer_state || data.place_of_supply || ''));
