const MAP = {
    en: {
        ...
        outcomeCheck: 'Morbeez follow-up (7–14 day outcome check) — how is the crop after treatment?\n\nTap one option below (or reply 1–4).\n\nOptional: send a latest leaf photo after this.',
        ...
        appliedThanks: 'Thank you! We recorded that you applied the recommendation. We will check outcome in about 7 days (and again around day 14).',
        improvedThanks: 'Great — crop recovered. This helps us improve future advice.',
        slightImprovementThanks: 'Noted — partially improved. Keep following the plan; we may check again around day 14.',
        noImprovementReply: 'Thank you for the update. Our agronomist team will review your case and contact you soon.',
