...
export const compatibilityOverrideService = {
    ...
    async listAggregates(days = 90) {
        ...
        for (const row of data ?? []) {
            const pairs = row.incompatible_pairs ?? [];
        ...
        const unknownPairRate = unknownChecks > 0 ? Math.round((unknownHits / unknownChecks) * 1000) / 10 : 0;
        return {
            totalOverrides,
...
//# sourceMappingURL=compatibility-override.service.js.map