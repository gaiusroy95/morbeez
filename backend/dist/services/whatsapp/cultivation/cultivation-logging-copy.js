...
export function appliedThanks(lang) {
    const map = {
...
export function notYetReminder(lang) {
    const map = {
...
export function resultValidationPrompt(lang) {
    const map = {
...
export function outcomeBetter(lang) {
    const map = {
...
export function outcomePartial(lang) {
    const map = {
...
export function outcomeNoImprovement(lang) {
    const map = {
...
export function sprayLogged(lang, crop) {
...
//# sourceMappingURL=cultivation-logging-copy.js.map