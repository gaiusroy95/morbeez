...
function marketLabelFromPin(row) {
...
export const marketInsightRegionService = {
    async resolveForFarmer(farmerId) {
        const { data: farmer, error } = await supabase
            .from('farmers')
            .select('pincode_id, delivery_pincode, district, pincode_master(pincode, village, taluk, district, state, latitude, longitude)')
            .eq('id', farmerId)
            .maybeSingle();
...
//# sourceMappingURL=market-insight-region.service.js.map