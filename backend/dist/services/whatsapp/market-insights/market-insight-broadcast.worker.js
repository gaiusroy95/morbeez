...
let interval = null;
export function startMarketInsightBroadcastWorker() {
    if (env.NODE_ENV === 'test' || !env.ENABLE_MARKET_INSIGHT_IMAGE_BROADCAST)
        return;
    if (interval)
        return;
...
export async function runMarketInsightsNow(options) {
    return marketInsightBroadcastService.runDaily(options);
}
//# sourceMappingURL=market-insight-broadcast.worker.js.map