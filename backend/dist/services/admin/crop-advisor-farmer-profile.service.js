...
export const cropAdvisorFarmerProfileService = {
            ...
            for (const block of input.cropBlocks) {
                ...
                if (block.id) {
                    await crmFarmerService.updateBlock(block.id, {
                        ...
                        location_source: block.latitude != null && block.longitude != null ? 'crop_advisor' : undefined,
...
//# sourceMappingURL=crop-advisor-farmer-profile.service.js.map