...
export const incentiveCalculatorService = {
    async estimateMonthlyIncentive(employeeProfileId, monthSalesInr, conversionRatePct) {
        ...
        const conversionBonus = data.conversion_bonus_enabled && conversionRatePct > conversionTarget ? additional : 0;
        ...
        const totalBonus = estimatedIncentive + conversionBonus + retentionBonus + relationshipBonus + followUpBonus;
        return { estimatedIncentive, conversionBonus, totalBonus };
    },
};
//# sourceMappingURL=incentive-calculator.service.js.map