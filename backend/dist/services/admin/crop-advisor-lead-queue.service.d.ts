import { cropAdvisorAdminService, type CropAdvisorListQuery } from './crop-advisor-admin.service.js';
...
export type OperationalLeadRow = Awaited<ReturnType<typeof cropAdvisorAdminService.listLeads>>['leads'][number] & {
...
export declare const cropAdvisorLeadQueueService: {
...
//# sourceMappingURL=crop-advisor-lead-queue.service.d.ts.map