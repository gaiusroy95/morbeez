...
export declare const cropAdvisorAdminService: {
    ...
    listLeads(query: CropAdvisorListQuery, agentEmail: string): Promise<{
        leads: ({
            id: unknown;
            farmerId: unknown;
            intent: unknown;
...
//# sourceMappingURL=crop-advisor-admin.service.d.ts.map