...
function applyCropAdvisorLeadScope(builder, scope, agentEmail) {
    if (scope === 'mine') {
...
export const cropAdvisorAdminService = {
    ...
    async listLeads(query, agentEmail) {
        ...
        const { cropAdvisorIntelligenceService } = await import('../intelligence/crop-advisor-intelligence.service.js');
    ...
    async updateLead(leadId, patch, agentEmail) {
        ...
        if (patch.assignedTo !== undefined) {
            ...
            void farmerOwnershipService.syncCropAdvisorAssignment(data.farmer_id, patch.assignedTo ?? null);
        }
        if (patch.assignedTo) {
            const { farmerEventCaptureService } = await import('../intelligence/farmer-event-capture.service.js');
...
//# sourceMappingURL=crop-advisor-admin.service.js.map