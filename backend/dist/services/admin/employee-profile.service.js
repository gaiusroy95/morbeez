...
export const employeeProfileService = {
    ...
    async create(input) {
        ...
        const { data, error } = await supabase
            ...
            agronomist_tier: input.role === 'agronomist' ? (input.agronomistTier ?? 'new') : 'new',
            created_at: now,
            updated_at: now,
        })
            .select('*')
    ...
    async resolveStaffReference(id) {
    ...
    async syncAdminActive(profileId, active) {
