...
export const marketingSpendService = {
    ...
    async updateIncentiveRule(id, patch) {
        const updates = { updated_at: new Date().toISOString() };
        if (patch.flatConnectedInr !== undefined)
            updates.flat_connected_inr = patch.flatConnectedInr;
        if (patch.flatBookedInr !== undefined)
            updates.flat_booked_inr = patch.flatBookedInr;
        if (patch.flatPaidInr !== undefined)
            updates.flat_paid_inr = patch.flatPaidInr;
        if (patch.monthlyCapInr !== undefined)
            updates.monthly_cap_inr = patch.monthlyCapInr;
...
//# sourceMappingURL=marketing-spend.service.js.map