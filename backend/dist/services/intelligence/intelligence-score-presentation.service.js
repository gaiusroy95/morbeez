...
export function farmerEmployeeInsights(metrics, classification) {
    ...
    let cropAdvisor = null;
    let agronomist = null;
    if (eng >= 75)
        cropAdvisor = 'Excellent engagement builder';
    else if (eng >= 45)
        cropAdvisor = 'Moderate engagement — room to grow';
        ...
        cropAdvisor = 'Needs stronger follow-up and WhatsApp engagement';
    if (trust >= 80)
