...
function moduleScore(module, score, completeness, source) {
    return {
        module,
...
export const gingerSopConfidenceService = {
    buildModuleScores(input) {
        ...
        const canopyScore = input.canopyModuleScore ??
    ...
    fusedConfidence(modules, modelConfidence, plantId) {
...
//# sourceMappingURL=ginger-sop-confidence.service.js.map