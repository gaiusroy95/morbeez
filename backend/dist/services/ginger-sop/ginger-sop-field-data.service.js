...
export const gingerSopFieldDataService = {
    ...
    buildFieldMetrics(measurements) {
    ...
    buildWaterReading(measurements, metadata) {
    ...
    buildCanopyAudit(measurements, dap, canopyCoverPct) {
    ...
    async loadFieldContext(params) {
        ...
        const canopyAudit = this.buildCanopyAudit(measurements, params.dap, measurements.get('canopy_cover') ?? null);
        return {
            findingId,
            fieldMetrics,
            canopyAudit,
...
//# sourceMappingURL=ginger-sop-field-data.service.js.map