...
export const recommendationService = {
    recommend(cropType, advisory) {
        ...
        for (const rule of rules.rules) {
            if (rule.matchTags.includes('default'))
                continue;
            if (!tagsMatch(rule.matchTags, tags, issue))
                continue;
