# CropAdvisor mobile smoke checklist

Production cropAdvisor app: `apps/cropAdvisor` (`crop_advisor_crm` module).
...
1. Login as cropAdvisor staff (email + password or OTP)
...
Offline call upload queue: `cropAdvisorClient.flushOfflineQueue()` from dashboard.
