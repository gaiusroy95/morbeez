-- Ginger advisory workflow — 3 sample blocks + soil reports for existing farmer (+916282873542)
-- Does NOT create a demo farmer. Safe to re-run (fixed block/report UUIDs + upsert).
...
BEGIN
  ...
  IF v_farmer_id IS NULL THEN
    RAISE EXCEPTION 'Farmer with phone ending 6282873542 not found — create the farmer before running this migration';
  END IF;
