    ...
    <div class="esc-detail">
      ...
      ${
        ...
        <div class="field">
          ...
          <textarea class="input" name="resolution" rows="2" placeholder="Final guidance for cropAdvisor">${escapeHtml(esc.resolution || '')}</textarea>
        </div>
...
export async function renderCropAdvisorEscalations() {
