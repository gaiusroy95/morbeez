...
export const DEMO_INTERACTIONS = [
  { atLabel: '23 May 2024, 4:30 PM', type: 'call', typeLabel: 'Call', icon: 'phone', by: 'Jithin Varghese', role: 'Crop Advisor', summary: 'Discussed nutrient deficiency and recommended foliar spray.', nextAction: 'Follow-up after 2 days', nextDate: '25 May 2024', status: 'Completed', statusTone: 'success', block: 'Block A' },
  { atLabel: '22 May 2024, 11:15 AM', type: 'whatsapp', typeLabel: 'WhatsApp', icon: 'whatsapp', by: 'Jithin Varghese', role: 'Crop Advisor', summary: 'Shared product brochure and pricing for Potassium Nitrate.', nextAction: '—', nextDate: '', status: 'Sent', statusTone: 'info', block: '—' },
  ...
  { atLabel: '19 May 2024, 2:45 PM', type: 'follow_up', typeLabel: 'Follow-up', icon: 'phone', by: 'Jithin Varghese', role: 'Crop Advisor', summary: 'Farmer confirmed interest in drip nutrition schedule.', nextAction: 'Send quote', nextDate: '22 May 2024', status: 'Pending', statusTone: 'warning', block: '—' },
